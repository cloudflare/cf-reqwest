...
//!
//! Conversely, the functionality in `cf_reqwest::blocking` must *not* be executed
...
//! [`cf_reqwest::Client`][crate::Client] instead. If the immediate context is only
...
//! Reader, you can use the `cf_reqwest::blocking::Body::new()` constructor.
//!
//! ```rust
